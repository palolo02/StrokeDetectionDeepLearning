...
#https://github.com/Dootmaan/VNet.PyTorch/blob/main/model/VNet.py
...
class conv3d(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        #self.drop_out = nn.Dropout3d(p=0.2) # Adding regularization 
...
class conv3d_x3(nn.Module):
    ...
    def forward(self, x):
        ...
        z_2 = self.conv_2(z_1)
        z_3 = self.conv_3(z_2)
        z_4 = z_3 + self.skip_connection(x)
        return z_4
...
class conv3d_x2(nn.Module):
    ...
    def forward(self, x):
        z_1 = self.conv_1(x)
        z_2 = self.conv_2(z_1)
        z_3 = z_2 + self.skip_connection(x)
        return z_3
