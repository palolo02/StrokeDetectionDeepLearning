...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        model_state = torch.load('deepLearningModels/pretrained/res2net50_v1b_26w_4s-3cf99910.pth')
...
if __name__ == '__main__':
    ...
    lateral_map_5, lateral_map_3, lateral_map_2, lateral_map_1 = ras(input_tensor)
