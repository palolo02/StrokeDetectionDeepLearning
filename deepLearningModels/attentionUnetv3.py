...
class CustomAttentionUnetv3(nn.Module):

    def __init__(self, in_channels=1, out_channels=1, base_filter_num=32):
        super(CustomAttentionUnetv3, self).__init__()        
        # Encoder
...
def testModel3Channels():
    ...
    #print(x.shape)
    model = CustomAttentionUnetv3(in_channels=1, out_channels=1)
    pred = model(x)
    print(pred.shape)
